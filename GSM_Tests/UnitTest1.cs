...
namespace GSM_Tests
{
    public class UnitTest1
    {
        ...
        public void EncodeAlphabetTest()
        {
            ...
            Assert.Equal(GSM.Program.Encode("@£$¥èéùìòÇ\nØø\rÅå" + "Δ_ΦΓΛΩΠΨΣΘΞ\x1bÆæßÉ"
                            + " !\"#¤%&`()*+,-./" + "0123456789:;<=>?"
                            + "¡ABCDEFGHIJKLMNO" + "PQRSTUVWXYZÄÖÑÜ§"
                            + "¿abcdefghijklmno" + "pqrstuvwxyzäöñüà"), alphabet);
        }
        ...
        public void DecodeAlphabetTest()
        {
            ...
            Assert.Equal(GSM.Program.Decode(alphabet), alphabetString);
        }
        ...
        public void CheckRandomMessage()
        {
            ...
            {
                message += alphabet[rnd.Next(0, 119)];
            }

            Assert.Equal(message, GSM.Program.Decode(GSM.Program.Encode(message)));
        }
    }
}
